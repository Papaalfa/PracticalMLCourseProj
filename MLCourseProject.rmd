...
I can see that there are 160 variables in total in the dataset. Most of them are data from the sensors, there are also timestamps data, a variable indicating the experiments participants and an indexing variable. I can also see that testing dataset is big enough so I can split it to training and probe sets to evaluate out of sample error rate.
```{r}
...
I can see that accuracy is still very high. So it's time to calculate an out of sample error rate
```{r}
